...
public final class USBMonitor {
	...
	public synchronized void register() throws IllegalStateException {
		...
		if (mPermissionIntent == null) {
			...
			if (context != null) {
				// Use explicit Intent (with package) + FLAG_MUTABLE for USB permission.
				// Android 14+ (SDK 34) requires explicit intents with FLAG_MUTABLE.
				// FLAG_MUTABLE is needed so the system can fill in USB device extras.
